    ...
    monthlyData: [
      {
        ...
        revenue: "$23450.50",
        expenses: "$18932.43",
        operationalExpenses: "$13450.12",
        nonOperationalExpenses: "$5482.31",
      },
      {
        month: "february",
        revenue: "$21520.67",
        expenses: "$17640.30",
        operationalExpenses: "$12480.34",
        nonOperationalExpenses: "$5160.96",
      },
      {
        month: "march",
        revenue: "$24389.33",
        expenses: "$19220.48",
        operationalExpenses: "$13680.54",
        nonOperationalExpenses: "$5540.94",
      },
      {
        month: "april",
        revenue: "$25420.15",
        expenses: "$20310.50",
        operationalExpenses: "$14920.67",
        nonOperationalExpenses: "$5390.83",
      },
      {
        month: "may",
        revenue: "$23880.72",
        expenses: "$18040.89",
        operationalExpenses: "$12980.77",
        nonOperationalExpenses: "$5060.12",
      },
      {
        month: "june",
        revenue: "$24950.48",
        expenses: "$18980.42",
        operationalExpenses: "$13920.33",
        nonOperationalExpenses: "$5060.09",
      },
      {
        month: "july",
        revenue: "$26380.59",
        expenses: "$20550.72",
        operationalExpenses: "$15340.89",
        nonOperationalExpenses: "$5210.83",
      },
      {
        month: "august",
        revenue: "$27890.36",
        expenses: "$22340.59",
        operationalExpenses: "$16980.15",
        nonOperationalExpenses: "$5360.44",
      },
      {
        month: "september",
        revenue: "$29080.50",
        expenses: "$23450.88",
        operationalExpenses: "$17430.22",
        nonOperationalExpenses: "$6020.66",
      },
      {
        month: "october",
        revenue: "$30840.91",
        expenses: "$24950.31",
        operationalExpenses: "$19080.12",
        nonOperationalExpenses: "$5870.19",
      },
      {
        month: "november",
        revenue: "$31560.72",
        expenses: "$25640.92",
        operationalExpenses: "$19850.35",
        nonOperationalExpenses: "$5790.57",
      },
      {
        month: "december",
        revenue: "$33320.15",
        expenses: "$26980.14",
        operationalExpenses: "$21280.41",
        nonOperationalExpenses: "$5699.73",
      },
